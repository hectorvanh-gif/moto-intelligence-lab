  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-semibold ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 font-display uppercase tracking-wider",
  {
    variants: {
      variant: {
        ...
        // Moto Lab custom variants
        neon: "bg-primary text-primary-foreground neon-glow hover:scale-105 active:scale-95 rounded-sm",
        hero: "bg-primary text-primary-foreground neon-glow hover:scale-105 active:scale-95 text-base rounded-sm",
        nav: "bg-primary/90 text-primary-foreground hover:bg-primary neon-glow text-xs rounded-sm",
        ghost_nav: "text-foreground hover:text-primary transition-colors rounded-md",
      },
      size: {
